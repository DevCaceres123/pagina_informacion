 ...
 */
class EstadisticaTituladoFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'fecha_colacion' => '2025-01-23', // fecha fija
            'grado_academico' => $faker->randomElement(['tecnico medio','tecnico superior','licenciatura']),
            'created_at' => now(),
            'updated_at' => now(),
        ];
    }
