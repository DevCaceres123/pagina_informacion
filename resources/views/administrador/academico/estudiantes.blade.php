...
@section('contenido')
            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="row mb-4 align-items-end">
                        ...
                        <div class="col-md-3">
                            <label for="gestion_filtro" class="form-label fw-bold">
                                Ver estadísticas de:
                            </label>
                    ...
                    <div class="text-end mt-4">
                        ...
                        @can('estudiantes.generar_reporte')
    ...
    <div class="modal fade" id="modalSubirDatos" tabindex="-1" aria-labelledby="modalReporteLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <i class=""></i>Importar Planilla Estudiantes</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="container">
