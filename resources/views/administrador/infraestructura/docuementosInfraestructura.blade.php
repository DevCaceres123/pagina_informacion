            ...
            <div class="card-body">
                ...
                <div class="mb-4 p-3 border rounded bg-light">
                    ...
                    @if(!empty($infraestructura->solicitud))
                        <div class="mb-2">
                            <a href="{{ Storage::url($infraestructura->solicitud) }}" target="_blank" class="btn btn-outline-success btn-sm">
                                📄 Ver Solicitud
                            </a>
                        </div>
                    @endif
                    ...
                    <form id="form-solicitud" enctype="multipart/form-data" class="d-flex align-items-center gap-2">
                        @csrf
                        <input type="file" name="solicitud" class="form-control form-control-sm" accept="application/pdf">
                        <button type="button" class="btn btn-sm btn-primary btn-enviar" data-tipo="solicitud">
                            ⬆️ Subir / Actualizar
                        </button>
                    </form>
                </div>
                ...
                <div class="mb-4 p-3 border rounded bg-light">
                    ...
                    <p class="text-muted small mb-2">Aquí debe cargarse la <strong>Nota</strong> y su número correspondiente.</p>

                    @if(!empty($infraestructura->nota))
                        <div class="mb-2">
                            <a href="{{ Storage::url($infraestructura->nota) }}" target="_blank" class="btn btn-outline-success btn-sm">
                                📄 Ver Nota
                            </a>
                    ...
                    <form id="form-nota" enctype="multipart/form-data" class="row g-2">
                        @csrf
                        <div class="col-md-6">
                            <input type="file" name="nota" class="form-control form-control-sm" accept="application/pdf">
                        </div>
                        <div class="col-md-4">
                            <input type="text" name="numero_nota" class="form-control form-control-sm" 
                                   placeholder="N° Nota" value="{{ $infraestructura->numero_nota ?? '' }}">
                        </div>
                        <div class="col-md-2">
                            <button type="button" class="btn btn-sm btn-warning w-100 btn-enviar" data-tipo="nota">
                                ⬆️ Guardar
                            </button>
                        </div>
                    </form>
                ...
                <div class="mb-4 p-3 border rounded bg-light">
                    ...
                    @if(!empty($infraestructura->contrato))
                        <div class="mb-2">
                            <a href="{{ Storage::url($infraestructura->contrato) }}" target="_blank" class="btn btn-outline-success btn-sm">
                                📄 Ver Contrato
                            </a>
                        </div>
                    @endif
                    ...
                    <form id="form-contrato" enctype="multipart/form-data" class="d-flex align-items-center gap-2">
                        @csrf
                        <input type="file" name="contrato" class="form-control form-control-sm" accept="application/pdf">
                        <button type="button" class="btn btn-sm btn-success btn-enviar" data-tipo="contrato">
                            ⬆️ Subir / Actualizar
                        </button>
                    </form>
                </div>
